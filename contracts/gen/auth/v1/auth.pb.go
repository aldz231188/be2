...
type ValidateAccessResponse struct {
	...
	TokenVersion  int32                  `protobuf:"varint,3,opt,name=token_version,json=tokenVersion,proto3" json:"token_version,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ValidateAccessResponse) GetTokenVersion() int32 {
	if x != nil {
...
const file_auth_v1_auth_proto_rawDesc = "" +
	...
	"\rtoken_version\x18\x03 \x01(\x05R\ftokenVersion2\x91\x03\n" +
	"\vAuthService\x126\n" +
	...
	"\tLogoutAll\x12\x19.auth.v1.LogoutAllRequest\x1a\x16.google.protobuf.Empty\x12Q\n" +
	"\x0eValidateAccess\x12\x1e.auth.v1.ValidateAccessRequest\x1a\x1f.auth.v1.ValidateAccessResponseB\"Z be2/contracts/gen/auth/v1;authv1b\x06proto3"
...
var file_auth_v1_auth_proto_goTypes = []any{
	...
	(*ValidateAccessRequest)(nil),  // 9: auth.v1.ValidateAccessRequest
	(*ValidateAccessResponse)(nil), // 10: auth.v1.ValidateAccessResponse
...
var file_auth_v1_auth_proto_depIdxs = []int32{
	...
	9,  // 8: auth.v1.AuthService.ValidateAccess:input_type -> auth.v1.ValidateAccessRequest
	2,  // 9: auth.v1.AuthService.Login:output_type -> auth.v1.LoginResponse
	4,  // 10: auth.v1.AuthService.Register:output_type -> auth.v1.RegisterResponse
	6,  // 11: auth.v1.AuthService.Refresh:output_type -> auth.v1.RefreshResponse
	11, // 12: auth.v1.AuthService.Logout:output_type -> google.protobuf.Empty
	11, // 13: auth.v1.AuthService.LogoutAll:output_type -> google.protobuf.Empty
	10, // 14: auth.v1.AuthService.ValidateAccess:output_type -> auth.v1.ValidateAccessResponse
