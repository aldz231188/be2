...
const (
	...
	AuthService_LogoutCurrent_FullMethodName       = "/auth.v1.AuthService/LogoutCurrent"
...
type AuthServiceClient interface {
	Authenticate(ctx context.Context, in *AuthenticateRequest, opts ...grpc.CallOption) (*TokenPairResponse, error)
...
func (c *authServiceClient) Authenticate(ctx context.Context, in *AuthenticateRequest, opts ...grpc.CallOption) (*TokenPairResponse, error) {
...
func (c *authServiceClient) LogoutCurrent(ctx context.Context, in *LogoutRequest, opts ...grpc.CallOption) (*LogoutResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LogoutResponse)
	err := c.cc.Invoke(ctx, AuthService_LogoutCurrent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	Authenticate(context.Context, *AuthenticateRequest) (*TokenPairResponse, error)
...
func (UnimplementedAuthServiceServer) Authenticate(context.Context, *AuthenticateRequest) (*TokenPairResponse, error) {
...
func (UnimplementedAuthServiceServer) LogoutCurrent(context.Context, *LogoutRequest) (*LogoutResponse, error) {
...
func _AuthService_LogoutCurrent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LogoutRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).LogoutCurrent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_LogoutCurrent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).LogoutCurrent(ctx, req.(*LogoutRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_LogoutCurrent_Handler,
		},
		{
