...
type ClientService interface {
	CreateClient(ctx context.Context, c domain.Client) (string, error)
...
func NewClientService(clientRepo domain.ClientRepo) ClientService {
...
func (s *clientService) CreateClient(ctx context.Context, c domain.Client) (string, error) {
